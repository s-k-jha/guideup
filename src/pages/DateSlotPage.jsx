        ...
        <div className="px-4 sm:px-6 pt-4 pb-28 lg:pb-8">
          ...
          <div className="grid lg:grid-cols-[360px_1fr] gap-8 items-start">
            ...
            <Card className="p-5 min-h-[320px]">
              ...
              {date && loadingSlots && <LoadingState size="sm" label="Checking availability…" className="py-14" />}

              {date && !loadingSlots && slots.length === 0 && (
                <div className="text-center py-14 px-4 rounded-xl border border-dashed border-border">
              ...
              <div className="hidden lg:block mt-6">
                <Button onClick={handleContinue} disabled={!date || !selectedSlot} className="w-full h-11">
